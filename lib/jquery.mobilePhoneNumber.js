...
(function() {
  var $, browserNotSupported, caretPosition_, checkForCountryChange_, formatBack_, formatForPhone_, formatUp_, format_, formats, formattedPhoneNumber_, formattedPhone_, isEventAllowedChar_, isEventAllowed_, mobilePhoneNumber, prefixesAreSubsets_, restrictEventAndFormat_, setCaretPosition_, withTimeout,
    __slice = [].slice;
  ...
  restrictEventAndFormat_ = function(e) {
    ...
    value = this.val();
    caretEnd = this.get(0).selectionEnd;
    ...
    return withTimeout((function(_this) {
      return function() {
        return setCaretPosition_.call(_this, _this.val().length);
      };
    })(this));
  };
  ...
  format_ = function(value, e) {
    ...
    if (phone !== this.val()) {
      ...
      if (!selectionAtEnd) {
        return withTimeout((function(_this) {
          return function() {
            return setCaretPosition_.call(_this, selection);
          };
        })(this));
      }
    }
  ...
  caretPosition_ = function() {
    return this[0].selectionStart;
  };

  setCaretPosition_ = function(position) {
